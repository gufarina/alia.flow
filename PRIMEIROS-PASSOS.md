...
Se a versao trouxer uma mudanca grande (que pode pedir uma acao sua), ele avisa antes
de aplicar e pede uma confirmacao - nao troca nada na sua frente sem voce saber.

**Se a atualizacao deu problema, de dois cliques em `reverter-alia.bat`.** Ele mostra
as copias de seguranca que existem (com data), pergunta qual voce quer e so troca de
volta depois que voce confirmar. Seus clientes e sua memoria nunca entram nisso.
