...
2. **Saudacao** - curta, na sequencia, sem "como posso ajudar", sem emoji, sem euforia. Escolha a
   variante certa (operador novo, recorrente, estudio vazio, ou estudio de exemplo - detectado
   pelo state.json com studio "Studio Exemplo" ou client acme-saas/acme-pulse) e reuse a que ja
   existe la, palavra por palavra. Nao invente saudacao nova.
