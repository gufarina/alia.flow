...
# aplicada do operador), o ANCESTRAL MAIS EXTERNO com Clients de verdade vence - e o que representa a
...
try {
    ...
    $vetos = @(
        ...
        @{ p = '(^|/)scripts/smoke-test-studio\.ps1$'; m = 'smoke DA INSTANCIA aplicada do operador, nao do motor (o smoke do motor e scripts/smoke-test.ps1)' },
