...
$productFiles = @("README.md","PRIMEIROS-PASSOS.md","VERSION","CHANGELOG.md","LICENSE","CREDITS.md","opencode.json","iniciar-alia.bat","atualizar-alia.bat","reverter-alia.bat",".gitattributes")
