...
$scriptsAllow = @(
  ...
  "harness-baseline.ps1","ensure-graphify.ps1","rsi-apply.ps1","rsi-heldout.ps1","_rsi-lib.ps1","sync-harness-adapters.ps1","rsi-promote-pattern.ps1","capability-check.ps1","task-sweep.ps1"
)
