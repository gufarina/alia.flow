...
# Estado atual do disco (mesma regra de exclusao do make-manifest, compartilhada via
# _manifest-exclude.ps1 - TASK-567: sem isso, studio/ em disco vira EXTRA e o defeito volta).
