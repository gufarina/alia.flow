...
# $scriptsAllow, comentario "Fora de proposito" - e o smoke DA INSTANCIA aplicada do operador, le
# clientes/squads REAIS do operador; nao existe essa instancia aplicada numa instalacao limpa). Achado
