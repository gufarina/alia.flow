...
## Pipeline de evolucao (finding -> proposal -> decisao)

> Fundido de evolution-pipeline.md em 09/09/2026 (arquivo proprio era redundante com esta secao
> e versioning.md; original em engine/_retired/). Como um achado sobre o motor vira mudanca real,
> sem sistema paralelo: FINDING -> OPP-NN -> decisao do CEO -> pipeline de versao -> Gate.
