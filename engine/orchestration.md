...
## Plano de varias etapas tem diario em disco (LEI, TASK-598, 15/09/2026)

> LEI: toda Task que se desdobra em varias etapas (um PLANO) tem um ARQUIVO VIVO em disco -
> `artifacts/<slug>/PLANO.md`, com uma tabela de andamento - que e a fonte da verdade do avanco,
> nunca a conversa. Ao abrir sessao sobre um plano existente, LE o arquivo ANTES de qualquer coisa
> e ataca a primeira etapa cujo Estado nao e `FEITA`; nunca recomeca do inicio, nunca pula etapa.
> Estados possiveis, SO ESTES QUATRO: `NAO INICIADA`, `EM ANDAMENTO`, `FEITA`, `BLOQUEADA` - sem
...
> que morre no meio: a proxima cola o mesmo comando e a regra "le antes de agir" resolve sozinha -
> mesma continuidade de "Turno, Sessao e Task" acima, aplicada ao nivel do PLANO.

Guardrail que confere esta lei: scripts/smoke-test.ps1, secao "Plano com diario: vocabulario de
Estado + FEITA exige artefato (TASK-598, L68)" - ver engine/governance/law-ledger.md, L68.
